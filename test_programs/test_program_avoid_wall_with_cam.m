...
% 20 cm, then turn back from the wall (spin 180), and take a picture.
% Uses IR sensor, 2 large motors, camera.
...
% Initialize camera (normally initialize all devices at once but this way
% saves battery)
ctrl.camera_init();

% Take a normalized picture and display it
